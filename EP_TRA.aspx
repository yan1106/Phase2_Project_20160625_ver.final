...
<script type="text/javascript">
    ...
    */
    ...
    var str_ver;
    var global_display_verber;
    var global_display_verper;
    var sign;

    function Confirm_dia() {

        
       
        var hide = document.getElementById("hide_value");
        ...
        {
            if (confirm('前一版版號:'+global_display_verber+' \n進版版號:'+global_display_verper+' \n是否要進版!')) {
                popup();
                __doPostBack('SAVE', '')
            }
            else
    ...
    $(function () {
        ...
        $("#dialogFrame").attr('src', 'loading.aspx');
        $("#dialogFrame")
...
<body style="width: 100%; height:100%">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel_EPTRA" runat="server">               
           <table id="EP_TRA_Compare" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:80%">
                
                 <tr >
                     <td class="style-head" colspan="4" rowspan="2">Key item</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td class="style-td-red">
                         <asp:Label ID="lab_POR_na" runat="server">na</asp:Label>
                     </td>
                     <td class="style-td-blue">
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-td-red">
                         <asp:Label ID="lab_POR1" runat="server">1</asp:Label>
                     </td>
                     <td class="style-td-blue">
                 ...
                 <tr class="style-td-gray">
                     <td class="style-keyitem-number" width="32">46</td>
                     <td class="style-keyitem-details" width="129">
                     ...
                     <td width="160" class="auto-style315">
                         <asp:Label ID="CAP_EP_55" runat="server"></asp:Label>
                     </td>
                     <td  width="114" class="auto-style315">
       ...
       <asp:Panel ID="Panel2" runat="server">
            <asp:Button ID="SAVE" runat="server" class="blueButton button2" Height="25px" OnClick="SAVE_Click" Text="Save" Width="100px" OnClientClick="Confirm_dia(); return false;"   />
            <asp:HiddenField ID="hide_value" runat="server" />
       </asp:Panel>
