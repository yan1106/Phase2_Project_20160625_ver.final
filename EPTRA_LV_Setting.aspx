<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EPTRA_LV_Setting.aspx.cs" Inherits="EPTRA_LV_Setting" %>
...
<script type="text/javascript">
    var count_lamp;
     ...
     $(function () {
         $("[id$=Customer_TB]").autocomplete({
             source: function (request, response) {
                 $.ajax({
                     url: '<%=ResolveUrl("EPTRA_LV_Setting.aspx/GetCustomer") %>',
     ...
     $(function () {
         $("[id$=ND_TB]").autocomplete({
             source: function (request, response) {
                 $.ajax({
                     url: '<%=ResolveUrl("EPTRA_LV_Setting.aspx/GetNewDevice") %>',
                     data: "{ 'prefix': '" + request.term + "'}",
                     dataType: "json",
                     type: "POST",
                     contentType: "application/json; charset=utf-8",
    ...
    function AddWork_Lv_Setting(Ver_Name, keyitem, stage) {
        ...
        $(function () {
            ...
            $("#dialog").dialog({
                ...
                width: 800,
                height: 500,
                title: "Lv_Setting(" + keyitem + "_" + stage + ")",
                modal: true,/*background disable*/
                buttons: {
                    "確認": function () {
                        if (confirm("你確定將Level更新?")) {

                            //window.parent.$('#cmdFilter').click();

                            document.getElementById('dialogFrame').contentWindow.call_butinsert(keyitem, stage);
                            count_lamp--;
                            (document.getElementById("Hide_Value").value--);
                            //window.child.$('#but_insert').click();
                            $(this).dialog("close");
                        }
    ...
    function set_lamp(str1, str2, sign) {

        var obj = document.getElementById('Imagebutton_' + str1 + '_' + str2);

        if (sign == "high") {
            obj.src = "icon/red.gif";

        }
        else if (sign == "mid") {
            obj.src = "icon/yellow.gif";

        }
        else if (sign == "low") {
            obj.src = "icon/green.gif";

        }
        else {
            obj.src = "icon/white.gif";
        }
        ...
        function reflash()
        {
            ...
            window.location.replace("EPTRA_LV_Setting.aspx");
            alert('送審成功!');
        }

        
        function LvSign_sign()
        {
            if(confirm('確定要將您設定的Lv送審?'))
            {
                //document.getElementById('sign_hf').value = "t";
                __doPostBack('cmdFilter', '')
            }
            else
            {
                //document.getElementById('sign_hf').value = "f";
            }
        }
        ...
        {
            if(confirm('返回上一頁，將會把所有設定過的Lv值刪除\n確定要返回上一頁嗎?'))
            {
                __doPostBack('Button_Cancel', '')
            }
        ...
        function ALL_Level(str,str2) {
            if (confirm('你確定要將ALL_LEVEL更改為'+str+'嗎?')) {
                if(str=="自行選擇LV")
                {
                    
                    __doPostBack('but_lv_int', '')
                }
                else if (str == "RC(Lv.3)")
                {
                    __doPostBack('But_All_Lv', '')
                }
            ...
            {
                    __doPostBack('But_Rec_Lv', '')
                
                if (str2 == "自行選擇LV") {

                    document.getElementById('ddl_select_alllv').selectedIndex = 0;
                    document.getElementById('hf_sign').value = "t";
                }
                   
                else if(str2 == "RC(Lv.3)"){
                    document.getElementById('ddl_select_alllv').selectedIndex = 1;
                    document.getElementById('hf_sign').value = "t";
                }                    
                else if (str2 == "MC(Lv.4)")
                {
                    document.getElementById('ddl_select_alllv').selectedIndex = 2;
                    document.getElementById('hf_sign').value = "t";
                }
                   
                else if (str2 == "LC(Lv.5)")
                {
                    document.getElementById('ddl_select_alllv').selectedIndex = 3;
                    document.getElementById('hf_sign').value = "t";
                }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="left">
            ...
            <asp:Panel ID="Panel_Query_Vername" runat="server">
            <asp:Label ID="lblError" runat="server" ForeColor="Red" Font-Size="Large"></asp:Label>

                <fieldset class="auto-style1" style="margin-left: auto; margin-right: auto; margin-bottom: auto;">
                <legend class="legend" style="font-size:medium;"><strong>LV_Setting</strong></legend>  
     ...
     <asp:Panel ID="Panel_eptraview" runat="server">
        <div class="div-eptramain">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EnableTheming="True" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated" Height="170px">
                <Columns>
                    <asp:ButtonField CommandName="Setting" Text="Setting">
    ...
    <asp:Panel ID="Panel_EPTRA" runat="server">
        ...
        <asp:LinkButton ID="Button_Cancel" runat="server" CausesValidation="False"  class="style-button_cancel"
            CommandName="Cancel" Text="取消" OnClick="Button_Cancel_Click"  OnClientClick = "Confirm_delete(); return false;" style="position:fixed;top:0px;left:0px;">       
        <img src="icon/Cancel.png" height="40px" width="40px" />
            </asp:LinkButton>

        <asp:Button ID="Save_Main_Lv_Status" runat="server" class="blueButton button2" 
        Height="30px"  Text="SignOff" Width="100px" OnClick="Save_Main_Lv_Status_Click" Style="position:fixed;top:40px;left:0px;" />
        
       

            <div style="width:20%;margin-left:120px;margin-bottom:-15px;margin-top:-10px;" >
                   
        <fieldset style="margin:auto;" class="fieldset" >
        <legend class="legend" style="font-size:medium;"><strong>ALL_LV_Select</strong></legend>
        ...
        <table>                    
             <tr>
                 ...
                 <td  class="td_newDevice">
                     <asp:DropDownList ID="ddl_select_alllv" width="100" runat="server"  OnSelectedIndexChanged="ddl_select_alllv_SelectedIndexChanged"  AutoPostBack="True" >                      
                         <asp:ListItem  Value="自行選擇LV">自行選擇LV</asp:ListItem>
                         <asp:ListItem  Value="RC(Lv.3)" >RC(Lv.3)</asp:ListItem>
                         <asp:ListItem  Value="MC(Lv.4)" >MC(Lv.4)</asp:ListItem>    
                         <asp:ListItem  Value="LC(Lv.5)">LC(Lv.5)</asp:ListItem>    
         ...
         <br />       
           ...
           <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:80%;top:0px;left:0px;">
                 ...
                 <tr >
                     ...
                     <th class="style-Effect">Potential <br> Effect</th>                    
                 ...
                 <tr class="style-td-gray" height="42">
                     <td class="style-keyitem-details" height="42" width="192"><asp:Label ID="Lab_keyitem_44_5" runat="server" Text="Low SPEC of min RDL Width" >Low SPEC of <br> &nbsp;min RDL Width</asp:Label>
                     </td>
                     <td>
                 ...
                 <tr class="style-td-gray" height="42">
                     <td class="style-keyitem-details" height="42" width="192"><asp:Label ID="Lab_keyitem_44_7" runat="server" Text="Min RDL Width/Spacing pattern & location">Min RDL <br> &nbsp;Width/Spacing
                         <br>&nbsp;pattern &amp; location</asp:Label>
                     </td>
        ...
        <asp:HiddenField ID="Hide_Value" runat="server" value="1" />
        <asp:HiddenField ID="hf_sign" runat="server" value="s" />

    </asp:Panel>
        <asp:HiddenField ID="hf_Ver_Name" runat="server" value="x" />
        <asp:HiddenField ID="hf_KeyItem" runat="server" value="y" />
        <asp:HiddenField ID="hf_stage" runat="server" value="z" />
        <asp:HiddenField ID="hf_Lvsign" runat="server" value="lv" />
        <asp:Button ID="cmdFilter" runat="server"  Text="Button" ClientIDMode="Static" Style="display: none;"   OnClick="cmdFilter_Click"/>
        <asp:Button ID="but_lv_int" runat="server"  Text="Button" ClientIDMode="Static" Style="display: none;"    OnClick="but_lv_int_Click"/>  
       <asp:Button ID="But_All_Lv" runat="server"  Text="Button" ClientIDMode="Static" Style="display: none;"      OnClick="But_All_Lv_Click" />
        <asp:Button ID="But_Rec_Lv" runat="server"  Text="Button" ClientIDMode="Static" Style="display: none;"      OnClick="But_Rec_Lv_Click"/>
